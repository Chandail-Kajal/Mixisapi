...
function NoCode() {
  return (
    <>
      ...
      >
        <h1 className="w-full text-3xl md:text-5xl font-extrabold text-center text-green-900 mb-8">
          Build WhatsApp Chatbots{" "}
          <span className="text-green-600">No-Code</span>
        </h1>

        <ul className="list-disc list-inside space-y-4 text-lg text-gray-800 w-full max-w-screen-xl mb-8">
          <li>
          ...
          <li>
            ...
            <span className="relative text-green-600 font-semibold cursor-pointer group">
              WhatsApp
              <span className="absolute left-0 -bottom-1 h-[2px] bg-current"></span>
            </span>
          </li>
          <li>
