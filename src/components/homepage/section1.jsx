    ...
    return (
        <div>
            <div className="w-full text-white text-center py-3 px-4 sm:px-6 text-base sm:text-lg md:text-xl font-semibold tracking-wide shadow-md relative ">
                ...
                <div className="relative z-10 text-yellow-300 text-2xl">Buy → <span className="font-extrabold text-white">WhatsApp API and Get</span> = <span className="font-extrabold text-yellow-300 relative text-2xl sm:text-3xl md:text-4xl" style={{ textShadow: "rgb(0, 0, 0) 3px 3px 0px, rgba(0, 0, 0, 0.5) 4px 4px 0px, rgba(0, 0, 0, 0.5) 6px 6px 8px" }}>
                    Call Tracker</span>
                    <span className="font-extrabold underline text-white">FREE FREE FREE</span>
                </div>
            </div>
            <div className="min-h-screen [background-image:linear-gradient(rgba(59,130,246,0.1)_1px,transparent_0),linear-gradient(90deg,rgba(59,130,246,0.1)_1px,transparent_0)] [background-size:35px_35px]">
                <div className="relative overflow-hidden">
                    <div className="absolute inset-0 -z-10 h-full [background:radial-gradient(125%_125%_at_50%_10%,#fff_40%,#e0f2fe_100%)]">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-b from-white/80 to-blue-50/30"></div>
                    </div>
                        ...
                        <div className='max-w-7xl mx-auto relative z-10'>
                            <div className="flex flex-wrap justify-center gap-6 mb-10">
                                <div className="flex items-center gap-2 rounded-full border border-green-300 px-4 py-1 text-xs sm:text-base text-black font-semibold bg-gray-100 backdrop-blur-sm shadow-sm hover:border-green-500">
                                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512" className="w-6 h-6 text-green-700" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="flex items-center gap-2 rounded-full border border-green-300 px-4 py-1 text-xs sm:text-base text-black font-semibold bg-gray-100 backdrop-blur-sm shadow-sm hover:border-green-500">
                                    <img src="https://mittosapi.com/assets/metalogohero-D7d0DTBg.jpg" alt="Meta Logo" className="w-6 h-6 object-contain"/>Meta Business Partners
                                </div>
                                <div className="flex items-center gap-2 rounded-full border border-green-300 px-4 py-1 text-xs sm:text-base text-black font-semibold bg-gray-100 backdrop-blur-sm shadow-sm hover:border-green-500"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" 
                                className="lucide lucide-award w-6 h-6 text-yellow-700"><circle cx="12" cy="8" r="6"></circle>
                                <path d="M15.477 12.89 17 22l-5-3-5 3 1.523-9.11"></path></svg>Awarded by Mr. Ashneer Grover 2024</div>
                            </div>
                            <div className="grid lg:grid-cols-10 gap-2 items-center">
                                <div className="lg:col-span-6 flex flex-col justify-center space-y-4 text-center lg:text-left">
                                    <h1 className="text-6xl sm:text-6xl lg:text-6xl font-extrabold ">
                                        <span className="animated-gradient-text">100% Ban Proof</span>
                                        <br/>
                                        <span className="animated-gradient-text">Meta Verified API</span>
                                        </h1>
                                        <h2 className="text-3xl sm:text-6xl font-semibold text-gray-900">Send Unlimited WhatsApp Messages</h2>
                                        <p className="text-3xl sm:text-6xl text-green-500 font-bold"></p>
                                        <p className="text-gray-600 text-base sm:text-2xl max-w-xl mx-auto lg:mx-0"> World's most trusted and affordable complete business automation API platform</p>
                                        <p className="text-sm text-gray-500 flex sm:text-xl  items-center justify-center lg:justify-start">Powered by Official WhatsApp APIs 🔥</p>
                                        <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 pt-6">
                                            ...
                                            <button className="relative w-full sm:w-auto overflow-hidden rounded-xl border-2 border-green-500 bg-white px-8 py-3.5 text-lg font-semibold text-green-700 shadow-md transition-all duration-500 hover:shadow-2xl hover:-translate-y-1 group flex flex-col items-center justify-center">
                                                ...
                                                <div className="relative z-10 flex items-center gap-2 text-lg font-bold tracking-wide group-hover:text-white transition-colors duration-300">Switch and Save 
                                                    <span className="text-xl group-hover:translate-x-1 transition-transform"></span>
                                                </div>
                                                <p className="relative z-10 mt-1 text-xs text-gray-600 italic group-hover:text-green-100 transition-colors duration-300">only for existing API users</p>
                                                <span className="absolute -top-2 right-3 bg-gradient-to-r from-yellow-400 to-orange-400 text-[10px] font-bold text-black px-2 py-0.5 rounded-full shadow-md border border-yellow-300">OFFER</span>
                                        ...
                                        <p className="text-xl text-green-600 flex items-center justify-center lg:justify-start gap-2 mt-2"> 
                                           <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 576 512" className="w-8 h-6 text-blue-500" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div className="inline-flex items-center gap-2 rounded-full border border-green-300 px-4 py-1 text-xs sm:text-base text-black font-semibold bg-green-50 backdrop-blur-sm shadow-sm hover:border-green-500 w-fit">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-star w-6 h-6 text-yellow-500 fill-current"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                                            </svg>
                                            Best Alternative to Wati, AISensy, Double Tick and Interakt.
                                        </div>
                                </div>
                                <div className="lg:col-span-4 flex justify-center lg:justify-end">
                                    <img src="https://mittosapi.com/assets/Award-C0veRN4t.webp" alt="Business professionals" className="w-full max-w-sm sm:max-w-md lg:max-w-lg h-auto rounded-2xl"
                                    style={{boxShadow: "rgba(34, 197, 94, 0.5) 0px 25px 50px"}}/>
                                </div>
                            </div>
                            <div className="mt-12">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                                        <div className="flex flex-col items-center gap-2 p-6 rounded-2xl">
                                            <div className="flex text-yellow-400">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-star w-5 h-5 fill-current">
                                                    <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                                                </svg>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-star w-5 h-5 fill-current">
                                                    <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                                            ...
                                            <span className="text-sm text-gray-700 text-center font-medium">Never going back to any others</span>
                                        </div>
                                        <div className="flex flex-col items-center gap-2 p-6 rounded-2xl">
                                            <div className="flex text-yellow-400">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-star w-5 h-5 fill-current">
                                            ...
                                            <span className="text-sm text-gray-700 text-center font-medium">MittosAPI is an absolute must have!</span>
                                        </div>
                                        <div className="flex flex-col items-center gap-2 p-6 rounded-2xl">
                                            <div className="flex text-yellow-400">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-star w-5 h-5 fill-current">
                                            ...
                                            <span className="text-sm text-gray-700 text-center font-medium">MittosAPI is best in industry</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
