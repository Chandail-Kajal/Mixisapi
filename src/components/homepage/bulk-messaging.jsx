...
function BulkMessaging() {
  return (
    <>
      <div className="w-full  p-6 sm:p-10">
        ...
        >
          <h2 className="text-3xl sm:text-5xl font-bold text-gray-800 leading-tight">
            Send <span className="text-green-600">Unlimited Messages</span> just
            in One Click
          </h2>
          <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
            The Ultimate Tool To Automate, Schedule, And Optimize Your WhatsApp
            Marketing.
          </p>
        </section>
        <div className="grid md:grid-cols-3 gap-6 mt-10 max-w-6xl mx-auto">
          <div
            className="group p-6 rounded-2xl bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 border border-white/20"
            // style="opacity: 1; transform: none;"
          >
            ...
            <p className="text-gray-600 text-sm">
              Send same messages multiple times every day without manual effort.
            </p>
          </div>
          <div
            className="group p-6 rounded-2xl bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 border border-white/20"
          ...
          >
            ...
            <p className="text-gray-600 text-sm">
              Plan broadcasts up to 2 months in advance with precision.
            </p>
          </div>
          <div
            className="group p-6 rounded-2xl bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 border border-white/20"
          ...
          >
            ...
            <h3 className="font-semibold text-lg mb-2">Drip Campaigns</h3>
            <p className="text-gray-600 text-sm">
              Convert leads into customers with timed follow-ups.
            </p>
          </div>
        </div>
        <div className="mt-12 grid sm:grid-cols-2 md:grid-cols-3 gap-4 max-w-6xl mx-auto">
          <button
            className="flex items-center gap-3 px-7 py-2 rounded-xl bg-gradient-to-r from-green-500 to-green-400 text-white font-medium shadow-md hover:shadow-lg hover:scale-105 transition-transform"
            // style="opacity: 1; transform: none;"
          >
      ...
      <div class="w-full max-w-5xl mx-auto px-4 my-6">
        <img
          src="https://mittosapi.com/assets/100%20Ban%20Proof%20API%20(2)-C7SsEfdA.gif"
          alt="Ban Proof API"
          class="w-full h-auto object-contain rounded-lg shadow-md border-4 border-green-500"
        />
      </div>
    </>
  );
