    ...
    <section className="flex flex-col md:flex-row justify-center items-center min-h-screen p-4 md:p-8 bg-gradient-to-br from-green-100 via-white to-green-200 rounded-2xl relative overflow-hidden">
      <div className="flex flex-col md:flex-row flex-wrap gap-6 items-center">
        <ul className="flex flex-wrap gap-3 md:flex-col md:space-y-4 justify-center">
          <li
            className="w-fit cursor-pointer px-4 py-3 rounded-full flex items-center gap-3 shadow-md relative overflow-hidden transition-all duration-300 transform hover:scale-105 bg-white shadow-lg scale-105"
            tabindex="0"
          ...
          <li
            className="w-fit cursor-pointer px-4 py-3 rounded-full flex items-center gap-3 shadow-md relative overflow-hidden transition-all duration-300 transform hover:scale-105 bg-[#d6f5db] hover:bg-[#c8eecd]"
            tabindex="0"
            // style="opacity: 1; transform: none;"
          >
            <svg
