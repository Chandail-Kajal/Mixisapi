  ...
  return (
    <div className="flex flex-col min-h-screen w-full max-w-[100vw] overflow-x-hidden">
      <div className="flex-grow">
        ...
        <div className="w-full bg-green-50 py-10">
          <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div>
              <div className="flex flex-wrap gap-6 mb-5">
                <div className="flex items-center gap-2 rounded-full px-4 py-1 text-xs sm:text-base text-black font-semibold bg-green-200 backdrop-blur-sm shadow-sm hover:border-green-500">
                  ⚡ List E-commerce On WhatsApp
                </div>
              </div>
              <h2 className="text-4xl font-extrabold text-green-600">
                Sell More{" "}
                <span className="text-gray-900">With WhatsApp Catalog</span>
              </h2>

              <ul className="mt-8 space-y-3 text-lg text-gray-700">
                <li className="flex items-start gap-2">
                  <span className="text-green-600">🟢</span> Showcase product
                  directly on WhatsApp.
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-600">🟢</span> Complete checkout
                  process enabled.
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-600">🟢</span> Integrate
                  Woocommerce and Shopify.
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-600">🟢</span> Complete abandoned
                  cart recovery on WhatsApp.
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-600">🟢</span> Manage inventory on
                  WhatsApp.
                </li>
              </ul>
            ...
            <div className="flex justify-center">
              <img
                src="https://mittosapi.com/assets/Nocode-BDbRH3jI.png"
                alt="WhatsApp Demo"
        ...
        {/* You can continue converting the FAQ + Footer sections similarly here */}
      </div>
    </div>
  );
};
