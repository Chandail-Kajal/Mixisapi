  ...
  return (
    <div className="flex flex-col min-h-screen w-full max-w-[100vw] overflow-x-hidden">
      <div className="flex-grow">
        ...
        <div className="w-full max-w-4xl mx-auto px-4 mt-10">
          ...
          <div className="relative w-full aspect-video">
            <div
              ...
              aria-label="Play video: No Code Chatbot Builder Tutorial"
            >
              <img
                src="https://img.youtube.com/vi/BPKQhRUccHs/hqdefault.jpg"
                alt="No Code Chatbot Builder Tutorial"
        ...
        {/* FAQ and Footer would follow the same structure */}
      </div>
    </div>
  );
};
