  ...
  return (
    <div className="flex flex-col min-h-screen w-full max-w-[100vw] overflow-x-hidden">
      <div className="flex-grow">
        <div className="bg-green-50 py-5 px-6 lg:px-10 relative overflow-hidden">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <img
                src="https://mittosapi.com/assets/wpformsflow-OmiSstxI.png"
                alt="Girl with Megaphone"
                className="w-[300px] md:w-[380px] rounded-lg shadow-lg object-cover"
              />
          ...
          <div className="w-full max-w-4xl mx-auto px-4 mt-16">
            ...
            <div className="relative w-full aspect-video">
              <div
                ...
                aria-label="Play video: Appointment Booking Tutorial"
              >
                <img
                  src="https://img.youtube.com/vi/dWpsvpm9f3g/hqdefault.jpg"
                  alt="Appointment Booking Tutorial"
